...
public class MaterialDialog extends DialogBase implements
    ...
    protected View progress_layout = null;
    protected View content_layout = null;
...
//        footerview.setPadding(0,0,0,0);
    ...
    public void setTitleDivider(View titleDivider) {
    ...
    protected MaterialDialog(Builder builder) {
        ...
        try {
            ...
            if (builder.moreCallback!=null) {
                builder.moreCallback.init(this);
            }
        }catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if(mBuilder.items.length<=position) {
            Log.e("onItemClick","position="+position);
            if (mBuilder.moreCallback!=null) {
                mBuilder.moreCallback.onMore(this);
            }
            return;
        }
    ...
    private boolean sendSingleChoiceCallback(View v) {
        ...
        int index = 0;
        if (indexMap==null||indexMap.isEmpty()||indexMap.size()<=mBuilder.selectedIndex) {
            index = mBuilder.selectedIndex;
        } else {
            index = indexMap.get(mBuilder.selectedIndex);
        }
        return mBuilder.listCallbackSingleChoice.onSelection(this, v, index, text);
    }
...
//        Collections.sort(selectedIndicesList); // make sure the indicies are in order
    ...
    public static class Builder {
        ...
        protected int listDividerColor;
        ...
        protected MoreCallback moreCallback;
        ...
        protected boolean moreable = false;
        @DrawableRes
        ...
        private void checkSingleton() {
            ...
            if (s.titleDividerColor != 0)
                this.titleDividerColor = s.titleDividerColor;
            if (s.listDividerColor != 0)
                this.listDividerColor = s.listDividerColor;
            if (s.bottomDividerColor != 0)
                this.bottomDividerColor = s.bottomDividerColor;
        ...
        public Builder moreable(boolean moreable) {
            this.moreable = moreable;
            return this;
        }
        ...
        public Builder moreCallback(MoreCallback moreCallback) {
        ...
        public Builder searchable(boolean b) {
            searchable = b;
            return this;
        }
        ...
        public Builder titleDividerColor(@ColorInt int color) {
            this.titleDividerColor = color;
            return this;
        }

        public Builder titleDividerColorRes(@ColorRes int colorRes) {
            return titleDividerColor(this.context.getResources().getColor(colorRes));
        }

        public Builder titleDividerColorAttr(@AttrRes int colorAttr) {
            return titleDividerColor(DialogUtils.resolveColor(this.context, colorAttr));
        }

        public Builder bottomDividerColor(@ColorInt int color) {
            this.bottomDividerColor = color;
            return this;
        }

        public Builder bottomDividerColorRes(@ColorRes int colorRes) {
            return bottomDividerColor(this.context.getResources().getColor(colorRes));
        }

        public Builder bottomDividerColorAttr(@AttrRes int colorAttr) {
            return bottomDividerColor(DialogUtils.resolveColor(this.context, colorAttr));
        }

        public Builder listDividerColor(@ColorInt int color) {
            this.listDividerColor = color;
            return this;
        }

        public Builder listDividerColorRes(@ColorRes int colorRes) {
            return listDividerColor(this.context.getResources().getColor(colorRes));
        }

        public Builder listDividerColorAttr(@AttrRes int colorAttr) {
            return listDividerColor(DialogUtils.resolveColor(this.context, colorAttr));
        }
    ...
    public final void setItems(CharSequence[] items) {
        ...
        if (mBuilder.adapter instanceof MaterialDialogAdapter) {
            ...
            ((MaterialDialogAdapter) mBuilder.adapter).setData(items);
        } else {
            throw new IllegalStateException("When using a custom adapter, setItems() cannot be used. Set items through the adapter instead.");
        }
        DialogInit.showSearch(this);
        listView.setAdapter(mBuilder.adapter);
    }
    ...
    public interface MoreCallback {
        void onMore(MaterialDialog dialog);
        boolean init(MaterialDialog dialog);
    }
}